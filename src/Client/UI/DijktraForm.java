...
public class DijktraForm extends JFrame {
	...
	private void findpath() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "Không kết nối được");
		}
	...
	public void init() {
		...
		paneGraph = new Panneau(data.getVertexs(),data.getEdges());
		flag=true;
	...
	public DijktraForm() {
		...
		panel_1 = paneGraph;
		panel_1.setBounds(202, 11, 734, 693);
		...
		panel_2.setBounds(946, 11, 309, 693);
		...
		pane.setForeground(Color.red);
		pane.setBounds(10,48,182,356);
		contentPane.add(pane);
		
		JLabel lblNewLabel_1 = new JLabel("Dữ liệu đầu vào");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblNewLabel_1.setBounds(10, 11, 170, 26);
		...
		rbtnDdirectional.setBounds(6, 471, 159, 23);
		...
		rbtnScalar.setBounds(6, 515, 159, 23);
